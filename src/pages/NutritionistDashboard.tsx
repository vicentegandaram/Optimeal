      ...
      <main className="max-w-[450px] mx-auto bg-white min-h-[calc(100vh-72px)] pb-6">
        <div className="p-4">
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            ...
            >
              <Plus size={28} />
              <span className="font-semibold text-sm">Asignar</span>
            </button>
          </div>
          ...
          <div className="space-y-3">
            {patients.map((patient) => (
              ...
              >
                ...
                <p className="text-xs text-gray-500 mb-2">Adherencia: {patient.adherence}%</p>
                <button
                  onClick={() => openAssignModal(patient.id)}
                  className="w-full py-2 text-sm font-medium text-mint hover:bg-mint/5 rounded-lg transition"
                >
                  Asignar nueva pauta
                </button>
              </motion.div>
            ...
            >
              ...
              {modalType === 'upload' ? (
                <div className="space-y-4">
                  <p className="text-gray-500">Sube un archivo de pauta o genera una sugerida.</p>
                  <button
                    onClick={() => { setShowModal(false); navigate('/paciente'); }}
                    className="w-full bg-mint text-white font-semibold py-4 rounded-xl flex items-center justify-center gap-2"
                  >
                    <Check size={18} />
